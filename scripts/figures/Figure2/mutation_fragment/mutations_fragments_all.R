...
outdir <- "/Volumes/GoogleDrive/My Drive/Post-Doc/CHARM/LFS/LFS_clinical/figures/mutation_fragment"
options(scipen=999)
...
p <- ks.test(somatic_wildtype$somatic_wildtype, somatic_mutant$somatic_mutant)$p.value
