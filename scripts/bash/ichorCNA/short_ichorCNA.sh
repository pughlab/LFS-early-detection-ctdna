INPUTDIR=/cluster/projects/pughlab/external_data/TGL49_CHARM/LFS/LFS_WG/short_bams
PDIR=/cluster/projects/pughlab/projects/CHARM/LFS/ichorCNA
outdir=$PDIR/output/ichorCNA_short
shdir=$PDIR/sh_scripts/short
wig=$PDIR/output/wig_short
ichorCNA=/cluster/projects/pughlab/bin/ichorCNA
pon=/cluster/projects/pughlab/projects/CHARM/healthy_controls/ichorCNA/output/pon_short/CHARM_hg38_pon_median.rds
