...
output=/cluster/projects/pughlab/projects/CHARM/LFS/gatk_coverage/output/all_unique
shdir=/cluster/projects/pughlab/projects/CHARM/LFS/gatk_coverage/sh_scripts/all_unique
